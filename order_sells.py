...
class OrderSellsDialog(object):
    ...
    def submit(self):
        ...
        self.conn.execute(f'''
            update orders
            set result = "{self.cmbStatus.currentText()}", confirmed_book = "{'Да' if self.chkBooked.isChecked() else 'Нет'}"
            where id = {id_}
        ''')
        self.conn.commit()
    ...
    def cmb_changed(self):
        ...
        booked = self.conn.execute(f'''select confirmed_book from orders where id = {id_}''').fetchone()[0] == 'Да'
        self.chkBooked.setChecked(booked)

    def setupUi(self, MainWindow):
        self.win = MainWindow
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(442, 121)
        ...
        self.pushButton.setGeometry(QtCore.QRect(370, 90, 61, 21))
        self.pushButton.setObjectName("pushButton")
        self.pushButton.clicked.connect(self.submit)
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(270, 90, 89, 21))
        self.pushButton_2.setObjectName("pushButton_2")
        self.pushButton_2.clicked.connect(self.win.close)
        self.chkBooked = QtWidgets.QCheckBox(self.centralwidget)
        self.chkBooked.setGeometry(QtCore.QRect(10, 70, 281, 23))
        self.chkBooked.setObjectName("checkBox")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.chkBooked.setText(_translate("MainWindow", "Бронь подтверждена в отеле"))
